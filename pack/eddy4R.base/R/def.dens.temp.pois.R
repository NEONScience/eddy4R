##############################################################################################
#' @title Poisson's equation (adiabatic change) - density as function of temperature change
...
#' @examples dens02 <- def.dens.temp.pois(dens01 = 1.056, temp01 = 298.15, temp02 = 288.15, Kppa = eddy4R.base::Natu$KppaDry)
...
def.dens.temp.pois <- function(dens01, temp01, temp02, Kppa = eddy4R.base::Natu$KppaDry)  dens02 <- dens01 * (temp02/temp01)^((1-Kppa)/Kppa)
