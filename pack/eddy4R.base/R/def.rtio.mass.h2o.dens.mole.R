...
#' @param densMoleH2o A vector containing mole density of water vapor, of class "numeric". [molH2o m-3]
#' @param densMoleAirDry A vector containing the mole density of dry air, of class "numeric". [mol m-3]
