...
if(MethType == "vali"){
  outAttr$co2Turb <- base::list(
    "rtioMoleDryCo2Vali"= c("mean" = "umolCo2 mol-1Dry", "min" = "umolCo2 mol-1Dry", "max" = "umolCo2 mol-1Dry", "vari" = "umolCo2 mol-1Dry", "numSamp" = "NA", "rtioMoleDryCo2Refe" = "umolCo2 mol-1Dry", "rtioMoleDryCo2RefeCor" = "umolCo2 mol-1Dry", "timeBgn" = "NA", "timeEnd" = "NA"))
  outAttr$h2oTurb <- base::list(
...
#Only variables with conversion factors (i.e. multiplied differences should be converted using the unit conversion tool. Temp has an offset applied, this should not be performed for any variable with the mean removed, i.e. vari, se, etc.)
    ...
    if(MethType == "vali"){
      ...
      wrkAttr[[idxDp]][[idxVar]] <- c(baseAttr, baseAttr, baseAttr, baseAttr, baseAttr,  baseAttr, baseAttr, "NA", "NA")
