...
if(MethMeas == "ecse"){
  ...
  if(MethType == "data"){
    ...
    wrkAttr$rtioMoleDryCh4 <- c("mean" = "umolCh4 mol-1", "min" = "umolCh4 mol-1", "max" = "umolCh4 mol-1", "vari" = "umolCh4 mol-1", "numSamp" = "NA", "timeBgn" = "NA", "timeEnd" = "NA")
    wrkAttr$rtioMoleWetCh4 <- c("mean" = "umolCh4 mol-1", "min" = "umolCh4 mol-1", "max" = "umolCh4 mol-1", "vari" = "umolCh4 mol-1", "numSamp" = "NA", "timeBgn" = "NA", "timeEnd" = "NA")
    wrkAttr$rtioMoleDryCh4Refe <- c("mean" = "umolCh4 mol-1", "min" = "umolCh4 mol-1", "max" = "umolCh4 mol-1", "vari" = "umolCh4 mol-1", "numSamp" = "NA", "timeBgn" = "NA", "timeEnd" = "NA")
