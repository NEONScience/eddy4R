...
#' @examples dens02 <- def.dens.pres.pois(dens01 = 1.056, pres01 = 845, pres02 = 1000, Kppa = eddy4R.base::Natu$KppaDry)
...
def.dens.pres.pois <- function(dens01, pres01, pres02, Kppa = eddy4R.base::Natu$KppaDry)   dens02 = dens01 * (pres02/pres01)^(1-Kppa)
