...
#'   \item{MetrMile}{distance conversion, meters to miles = c(0,1/1609.34) [mi m-1]}
#'   \item{MileMetr}{distance conversion, miles to meters = c(0,1609.34) [m mi-1]}
...
#'   \item{InchMile}{distance conversion, inches to miles = c(0,1/12/5280) [mi in-1]}
#'   \item{MileInch}{distance conversion, miles to inches = c(0,12*5280) [in mi-1]}
#'   \item{FeetMile}{distance conversion, feet to miles = c(0,1/5280) [mi ft-1]}
#'   \item{MileFeet}{distance conversion, miles to feet = c(0,5280) [ft mi-1]}
