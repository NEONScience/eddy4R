...
#' @examples temp02 <- def.temp.pres.pois(temp01 = 298.15, pres01 = 845, pres02 = 1000, Kppa = eddy4R.base::Intl.Natu$KppaDry)
...
def.temp.pres.pois <- function(temp01, pres01, pres02, Kppa = eddy4R.base::Intl.Natu$KppaDry)   temp02 = temp01 * (pres02/pres01)^Kppa
