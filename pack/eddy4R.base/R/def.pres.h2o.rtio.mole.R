##############################################################################################
#' @title Calculate water vapor pressure from dry mole fraction and static pressure
...
#' @examples 
#' def.pres.h2o.rtio.mole(rtioMoleDryH2o = 6.52*1e-6, pres = 83000) 
#' def.pres.h2o.rtio.mole(rtioMoleDryH2o = c(6.52*1e-6, 11.617*1e-6, 4.931*1e-6), pres = c(83000, 65000, 110000)) 
...
def.pres.h2o.rtio.mole <- function(rtioMoleDryH2o, pres)  {
  #calculation
  ...
  # end function def.pres.h2o.rtio.mole()
}
