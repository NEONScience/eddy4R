...
# Distance
    ...
    Conv$MetrMile = c(0,1/1609.34) # [a0 a1] convert meters to miles [mi m-1]
    Conv$MileMetr = c(0,1609.34) # [a0 a1] convert miles to meters [m mi-1]
    Conv$InchFeet = c(0,1/12) # [a0 a1] convert inches to feet [ft in-1]
    Conv$FeetInch = c(0,12) # [a0 a1] convert feet to inches [in ft-1]
    Conv$InchMile = c(0,1/12/5280) # [a0 a1] convert inches to miles [mi in-1]
    Conv$MileInch = c(0,12*5280) # [a0 a1] convert miles to inches [in mi-1]
    Conv$FeetMile = c(0,1/5280) # [a0 a1] convert feet to miles [mi ft-1]
    Conv$MileFeet = c(0,5280) # [a0 a1] convert miles to feet [ft mi-1]
