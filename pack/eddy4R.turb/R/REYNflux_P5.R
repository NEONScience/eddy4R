...
REYNflux_FD_mole_dry <- function(
  ...
  data$rho_H2O <- data$p_H2O / eddy4R.base::Intl.Natu$Rg / data$T_air
  #total (wet) air density [mol m-3]
  data$rho_air <- data$p_air / eddy4R.base::Intl.Natu$Rg / data$T_air
  ...
  data$T_v <- data$T_air / (1 - ((data$p_H2O / data$p_air) * (1 - eddy4R.base::Intl.Natu$RtioMolmH2oDry)) )
  ...
  #data$cph <- (eddy4R.base::Intl.Natu$CpDry * data$rho_dry + eddy4R.base::Intl.Natu$CpH2o * data$rho_H2O) / data$rho_air
  data$cph <- (eddy4R.base::Intl.Natu$CpDry * 1 + eddy4R.base::Intl.Natu$CpH2o * data$FD_mole_H2O) / (1 + data$FD_mole_H2O)
  #cv as function of humidity  [J kg-1 K-1] == [m2 s-2 K-1]
  #data$cvh <- (eddy4R.base::Intl.Natu$CvDry * data$rho_dry + eddy4R.base::Intl.Natu$CvH2o * data$rho_H2O) / data$rho_air
  data$cvh <- (eddy4R.base::Intl.Natu$CvDry * 1 + eddy4R.base::Intl.Natu$CvH2o * data$FD_mole_H2O) / (1 + data$FD_mole_H2O)
  ...
  data$T_air_0 <- def.temp.pres.pois(temp01=data$T_air, pres01=data$p_air, pres02=eddy4R.base::Intl.Natu$Pres00, Kppa=mn$Kah)
  #virtual potential temperature at NIST standard pressure (1013.15 hPa) [K]
  data$T_v_0 <- def.temp.pres.pois(temp01=data$T_v, pres01=data$p_air, pres02=eddy4R.base::Intl.Natu$Pres00, Kppa=mn$Kah)
  ...
  if(PltfEc == "airc") mn$PSI_aircraft <- eddy4R.base::def.conv.poly(data=eddy4R.base::def.pol.cart(matrix(colMeans(eddy4R.base::def.cart.pol(eddy4R.base::def.conv.poly(data=data$PSI_aircraft,coefPoly=eddy4R.base::Intl.Conv$DegRad)), na.rm=TRUE), ncol=2)),coefPoly=eddy4R.base::Intl.Conv$RadDeg)
  ...
  imfl$F_H_en <- (eddy4R.base::Intl.Natu$CpDry * base$rho_dry * eddy4R.base::Intl.Natu$MolmDry + eddy4R.base::Intl.Natu$CpH2o * base$rho_H2O * eddy4R.base::Intl.Natu$MolmH2o) * imfl$F_H_kin
  ...
  imfl$F_LE_en <- base$Lv * eddy4R.base::Intl.Natu$MolmH2o * imfl$F_LE_kin
  ...
  if(flagCh4 == TRUE){
    ...
    imfl$F_CH4_mass <- imfl$F_CH4_kin * eddy4R.base::Intl.Natu$MolmCh4 * 1e6 * 3600
  ...
  mn$d_L_v_0 <- (-(
    ( (mn$u_star)^3 / 
        ( eddy4R.base::Intl.Natu$VonkFokn * eddy4R.base::Intl.Natu$Grav / mn$T_v_0 * mn$F_H_kin_v_0 )
    )
  ))
  ...
  mn$w_star <- ( eddy4R.base::Intl.Natu$Grav * mn$d_z_ABL / mn$T_v_0 * mn$F_H_kin_v_0 )^(1/3)
